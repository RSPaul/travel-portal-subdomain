                            ...
                            <div class="rounding_form_info">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group" >
                                        <input class="form-control departdate" type="text" name="departdate" id="departdate" required readonly value="{{ date('d-m-Y') }}" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group" >
                                        <input class="form-control returndate" type="text" name="returndate" readonly required value="{{ date('d-m-Y', strtotime(date('d-m-Y') . ' +1 day')) }}" />
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>{{ __('labels.roomguests')}} <i class="fa fa-angle-down" aria-hidden="true"></i></label>
                                    <input type="text" name="roomsGuests" id="roomsGuests" style="left:10px !important;" readonly class="form-control" required data-parsley-required-message="Please select the rooms & guests." placeholder="1 Room" value="Select Rooms & Guests">
                                    @include('_partials.hotel-guests')
                                </div>
                                <div class="search_btns_listing"><button type="submit" class="btn btn-primary show-loader">{{ __('labels.search')}}</button></div>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="listing_main_title">
                        ...
                        <br>
                        <section class="bread-cums no-padd">
                            <div class="container">
                                <div class="row">
                                    <div class="">
