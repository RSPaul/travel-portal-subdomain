...
<div ng-app="flighthotelApp" ng-controller="searchCtrl" id="hotelListPage" class="" ng-init="searchHotels(true)">
    <section class="listing_banner_forms" style="padding:5px 0px;">
        <div class="container">
            <div class="row" id="FilterToggleButton">
                <div class="col-8">
                    <p style="color:#1e4355;">
                        <strong>{{ $input['city_name']}} , {{ $input['roomsGuests']}} </strong> <br/>
                        {{ $input['departdate']}} TO {{ $input['returndate']}} 
                    </p>
                </div>
                <div class="col-4 text-right">
                    <button onclick="$('#searchRoomsForm').slideToggle();" style="padding:6px 10px;" type="button" class="btn btn-outline-dark btn-sm"><i class="fa fa-search"></i> Edit <i class="fa fa-chevron-down"></i> </button>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="listing_inner_forms">
                        <form method="GET" name="searchForm" id="searchRoomsForm"  class="hidemobileForm" action="{{ route('search_flight_rooms')}}"  >
                            @csrf
                            <div class="rounding_form_info" style="border-right:5px solid #b3cedd;border-left:5px solid #b3cedd;">
                                <div class="row">
                                        ...
                                        <div class="row" style="margin:0px;padding:0px;">
                                            <div class="col-12" style="padding:0px;">
                                                <div class="form-group" style="margin:0px !important;">
                                                    ...
                                                    <input type="hidden" name="from" id="from-city-fh" value="{{ $input['from']}}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin:0px;padding:0px;">
                                            ...
                                            <div class="col-12" style="padding:0px;background:#fff;">
                                                <div class="form-group" style="margin:0px !important;;">
                                                    ...
                                                    <input type="hidden" name="to" id="to-city-fh" value="{{ $input['to']}}">
                                                    <input type="hidden" name="countryCode" id="country_codefh" value="{{ $input['countryCode']}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2" style="padding:0px;background:#fff;border:2px solid #b3cedd;">
                                        ...
                                        <div class="form-group" style="margin:0px !important;;">
                                            <input id="autocompleteFH" name="Location" value="{{ $input['Location']}}"  placeholder="{{ __('labels.search_placeholder') }}"  onFocus="geolocateFH()" type="text" style="color:#333;border:1px solid #ccc;border-radius: 5px;padding:8px;font-size:14px;width:95%;" />

                                            <input type="hidden" name="Latitude" id="LatitudeFH" value="{{ $input['Latitude']}}">
                                            <input type="hidden" name="Longitude" id="LongitudeFH" value="{{ $input['Longitude']}}">
                                            <input type="hidden" name="Radius" id="RadiusFH" value="{{ $input['Radius']}}">
                                            <input type="hidden" name="city_id" id="city_id" value="{{ $input['city_id']}}">
                                            <input type="hidden" name="countryCode" id="country_codeFH" value="{{ $input['countryCode']}}">
                                            <input type="hidden" name="city_name" id="city_nameFH" value="{{ $input['city_name']}}">
                                            <input type="hidden" name="countryName" id="country_nameFH" value="{{ $input['countryName']}}">
                                    ...
                                    <div class="col-lg-3" style="padding:0px;background:#fff;border:2px solid #b3cedd;">
                                        ...
                                        <div class="row"  style="margin:0px;padding:0px;">
                                            <div class="col-12" style="padding:0px;">
                                                <div class="form-group" style="margin:0px !important;;">
                                                    <div class="input-group fhoteldt" style="padding-top:0px;">
                                                        <input type="text" id="dateRangeFH" value="{{ $input['departdate']}} - {{ $input['returndate']}}" class="form-control  text-center" />
                                                        <input id="departHotelFH" type="hidden" name="departdate" value="{{ $input['departdate']}}" />
                                                        <input id="returnHotelFH" type="hidden" name="returndate" value="{{ $input['returndate']}}" />
                                                    </div>
                                                </div> 
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-2" style="padding:0px;background:#fff;border:2px solid #b3cedd;">
                                        <div class="form-group" style="margin:0px !important;;">
                                            ...
                                            <input type="text" name="roomsGuests" id="roomsGuestsFH"  style="padding-top:0px;" readonly class="form-control text-center" required data-parsley-required-message="Please select the rooms & guests." placeholder="1 Room" value="{{ $input['roomsGuests']}}">
                                            @include('_partials.flight-hotel-guests-edit')
                                        </div>
                                    </div>
                                    <div class="col-lg-1" style="padding:0px;border:2px solid #b3cedd;">
                                        <div class="search_btns_listing" style="padding:0px;">
                                            <button type="submit"  style="border-radius: 0px !important;width:100%;" class="btn btn-primary flightHotelSearch">{{ __('labels.search')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4 searchHotelMobileFormMap">
                    <div class="map_vews">
                        <div class="search_location_data">
                            <input type="search" name="search" id="hotelNameMob"  ng-model='hotelNameMob'  placeholder="{{ __('labels.search_hotel_lbl')}}" autocomplete="off" ng-change="checkAndClearSearch()">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="listing_section_data data-section kkkl"  infinite-scroll="loadMore()"  infinite-scroll-distance="1">
        ...
        <div class="container" id="gridlistview">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 desktopOnlyView" ng-if="loaded">
                    <div class="listing_sidebar hotel" style="background:#fff;">
                            ...
                            <div data-v-f5a8416e="" class="display-block tw-hidden lg:tw-block">
                                <div data-v-f5a8416e="">
                                    <div class="tw-flex tw-items-center padd-10">
                                        ...
                                        <div class="flightlist" ng-if="flights1.Segments[0][0]">
                                            <div class="flex_width_air">
                                            <div class="vistara_Data">
                                                <img src="https://daisycon.io/images/airline/?width=100&height=50&color=ffffff&iata=@{{ flights1.Segments[0][0].Airline.AirlineCode}}" alt="@{{ flights1.Segments[0][0].Airline.AirlineName}}" />
                                                <span>@{{flights1.Segments[0][0].Airline.AirlineName}} 
                                                    @{{flights1.Segments[0][0].Airline.AirlineCode}} @{{flights1.Segments[0][0].Airline.FlightNumber}}
                                                </span> <span class="multistop" ng-if="flights1.Segments[0][2]">(2 stops)</span><span class="onestop" ng-if="flights1.Segments[0][1] && !flights1.Segments[0][2]">(1 stop)</span><span class="direct" ng-if="!flights1.Segments[0][1] && !flights1.Segments[0][2]">(Direct)</span>
                                            </div>
                                            <div class="main_flts_time">
                                                <div class="fllight_time_date">
                                                    <h5>@{{flights1.Segments[0][0].Origin.Airport.AirportCode}} <span>@{{flights1.Segments[0][0].Origin.Airport.CityName}}, @{{flights1.Segments[0][0].Origin.Airport.CountryName}}</span></h5>
                                                    <div class="time_flts">(@{{flights1.Segments[0][0].Origin.DepTime|  date:'HH:mm' }})</div>
                                                </div>

                                                <div class="flights1_duration" ng-if="flights1.Segments[0][2]">
                                                    <span>@{{ (flights1.Segments[0][0].Duration + flights1.Segments[0][1].Duration + flights1.Segments[0][2].Duration) | time:'mm':'hhh mmm':false}}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                                </div>
                                                <div class="flights1_duration" ng-if="flights1.Segments[0][1] && !flights1.Segments[0][2]">
                                                    <span>@{{ (flights1.Segments[0][0].Duration + flights1.Segments[0][1].Duration) | time:'mm':'hhh mmm':false}}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                                </div>
                                                <div class="flights1_duration" ng-if="!flights1.Segments[0][1] && !flights1.Segments[0][2]">
                                                    <span>@{{flights1.Segments[0][0].Duration| time:'mm':'hhh mmm':false }}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                                </div>
                                                <div class="fllight_time_date" ng-if="flights1.Segments[0][2]">
                                                    <h5>@{{flights1.Segments[0][2].Destination.Airport.AirportCode}} <span>@{{flights1.Segments[0][2].Destination.Airport.CityName}}, @{{flights1.Segments[0][2].Destination.Airport.CountryName}}</span></h5>
                                                    <div class="time_flts">(@{{ flights1.Segments[0][2].Destination.ArrTime |  date:'HH:mm' }})</div>
                                                </div>
                                                <div class="fllight_time_date" ng-if="flights1.Segments[0][1] && !flights1.Segments[0][2]">
                                                    <h5>@{{flights1.Segments[0][1].Destination.Airport.AirportCode}} <span>@{{flights1.Segments[0][1].Destination.Airport.CityName}}, @{{flights1.Segments[0][1].Destination.Airport.CountryName}}</span></h5>
                                                    <div class="time_flts">(@{{ flights1.Segments[0][1].Destination.ArrTime |  date:'HH:mm' }})</div>
                                                </div>
                                                <div class="fllight_time_date" ng-if="!flights1.Segments[0][1] && !flights1.Segments[0][2]">
                                                    <h5>@{{flights1.Segments[0][0].Destination.Airport.AirportCode}} <span>@{{flights1.Segments[0][0].Destination.Airport.CityName}}, @{{flights1.Segments[0][0].Destination.Airport.CountryName}}</span></h5>
                                                    <div class="time_flts">(@{{  flights1.Segments[0][0].Destination.ArrTime  |  date:'HH:mm' }}) </div>
                                                </div>

                                            </div>
                                        </div>
                                <div class="row mt-2" ng-if="flights1.Segments[1][0]">
                                    <div class="col-md-12">
                                        <div class="flex_width_air">
                                            <div class="vistara_Data">
                                                <img src="https://daisycon.io/images/airline/?width=100&height=50&color=ffffff&iata=@{{ flights1.Segments[1][0].Airline.AirlineCode}}" alt="@{{ flights1.Segments[1][0].Airline.AirlineName}}">
                                                <span>@{{ flights1.Segments[1][0].Airline.AirlineName}}
                                                    @{{ flights1.Segments[1][0].Airline.AirlineCode}}  @{{ flights1.Segments[1][0].Airline.FlightNumber}}
                                                </span> <span class="multistop" ng-if="flights1.Segments[1][2]">(2 stops)</span><span class="onestop" ng-if="flights1.Segments[1][1] && !flights1.Segments[1][2]">(1 stop)</span><span class="direct" ng-if="!flights1.Segments[1][1] && !flights1.Segments[1][2]">(Direct)</span>
                                            </div>
                                            <div class="main_flts_time">
                                                <div class="fllight_time_date">
                                                    <h5>@{{flights1.Segments[1][0].Origin.Airport.AirportCode}} <span>@{{flights1.Segments[1][0].Origin.Airport.CityName}}, @{{flights1.Segments[1][0].Origin.Airport.CountryName}}</span></h5>
                                                    <div class="time_flts">(@{{flights1.Segments[1][0].Origin.DepTime|  date:'HH:mm' }})</div>
                                                </div>

                                                <div class="flights1_duration"  ng-if="flights1.Segments[1][2]">
                                                    <span>@{{ (flights1.Segments[1][2].Duration + flights1.Segments[1][1].Duration + flights1.Segments[1][0].Duration) | time:'mm':'hhh mmm':false}}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                                </div>
                                                <div class="flights1_duration"  ng-if="flights1.Segments[1][1] && !flights1.Segments[1][2]">
                                                    <span>@{{ (flights1.Segments[1][1].Duration + flights1.Segments[1][0].Duration) | time:'mm':'hhh mmm':false}}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                                </div>
                                                <div class="flights1_duration"  ng-if="!flights1.Segments[1][1] && !flights1.Segments[1][2]">
                                                    <span>@{{ flights1.Segments[1][0].Duration | time:'mm':'hhh mmm':false }}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                                </div>

                                                <div class="fllight_time_date" ng-if="flights1.Segments[1][2]">
                                                    <h5>@{{flights1.Segments[1][2].Destination.Airport.AirportCode}} <span>@{{flights1.Segments[1][2].Destination.Airport.CityName}}, @{{flights1.Segments[1][2].Destination.Airport.CountryName}}</span></h5>
                                                    <div class="time_flts">(@{{flights1.Segments[1][2].Destination.ArrTime|  date:'HH:mm' }})</div>
                                                </div>

                                                <div class="fllight_time_date" ng-if="flights1.Segments[1][1] && !flights1.Segments[1][2]">
                                                    <h5>@{{flights1.Segments[1][1].Destination.Airport.AirportCode}} <span>@{{flights1.Segments[1][1].Destination.Airport.CityName}}, @{{flights1.Segments[1][1].Destination.Airport.CountryName}}</span></h5>
                                                    <div class="time_flts">(@{{flights1.Segments[1][1].Destination.ArrTime|  date:'HH:mm' }})</div>
                                                </div>

                                                <div class="fllight_time_date" ng-if="!flights1.Segments[1][1] && !flights1.Segments[1][2]">
                                                    <h5>@{{flights1.Segments[1][0].Destination.Airport.AirportCode}} <span>@{{flights1.Segments[1][0].Destination.Airport.CityName}}, @{{flights1.Segments[1][0].Destination.Airport.CountryName}}</span></h5>
                                                    <div class="time_flts">(@{{flights1.Segments[1][0].Destination.ArrTime|  date:'HH:mm' }})</div>
                                                </div>
                        ...
                        <div class="flightlist" ng-if="flights2.Segments[0][0]">
                            <div class="flex_width_air">
                                <div class="vistara_Data">
                                    <img src="https://daisycon.io/images/airline/?width=100&height=50&color=ffffff&iata=@{{ flights2.Segments[0][0].Airline.AirlineCode}}" alt="@{{ flights2.Segments[0][0].Airline.AirlineName}}" />
                                    <span>@{{flights2.Segments[0][0].Airline.AirlineName}} 
                                        @{{flights2.Segments[0][0].Airline.AirlineCode}} @{{flights2.Segments[0][0].Airline.FlightNumber}}
                                    </span> <span class="multistop" ng-if="flights2.Segments[0][2]">(2 stops)</span><span class="onestop" ng-if="flights2.Segments[0][1] && !flights2.Segments[0][2]">(1 stop)</span><span class="direct" ng-if="!flights2.Segments[0][1] && !flights2.Segments[0][2]">(Direct)</span>
                                </div>
                                <div class="main_flts_time">
                                    <div class="fllight_time_date">
                                        <h5>@{{flights2.Segments[0][0].Origin.Airport.AirportCode}} <span>@{{flights2.Segments[0][0].Origin.Airport.CityName}}, @{{flights2.Segments[0][0].Origin.Airport.CountryName}}</span></h5>
                                        <div class="time_flts">(@{{flights2.Segments[0][0].Origin.DepTime|  date:'HH:mm' }})</div>
                                    </div>

                                    <div class="flights2_duration" ng-if="flights2.Segments[0][2]">
                                        <span>@{{ (flights2.Segments[0][0].Duration + flights2.Segments[0][1].Duration + flights2.Segments[0][2].Duration) | time:'mm':'hhh mmm':false}}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                    </div>
                                    <div class="flights2_duration" ng-if="flights2.Segments[0][1] && !flights2.Segments[0][2]">
                                        <span>@{{ (flights2.Segments[0][0].Duration + flights2.Segments[0][1].Duration) | time:'mm':'hhh mmm':false}}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                    </div>
                                    <div class="flights2_duration" ng-if="!flights2.Segments[0][1] && !flights2.Segments[0][2]">
                                        <span>@{{flights2.Segments[0][0].Duration| time:'mm':'hhh mmm':false }}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                    </div>
                                    <div class="fllight_time_date" ng-if="flights2.Segments[0][2]">
                                        <h5>@{{flights2.Segments[0][2].Destination.Airport.AirportCode}} <span>@{{flights2.Segments[0][2].Destination.Airport.CityName}}, @{{flights2.Segments[0][2].Destination.Airport.CountryName}}</span></h5>
                                        <div class="time_flts">(@{{ flights2.Segments[0][2].Destination.ArrTime |  date:'HH:mm' }})</div>
                                    </div>
                                    <div class="fllight_time_date" ng-if="flights2.Segments[0][1] && !flights2.Segments[0][2]">
                                        <h5>@{{flights2.Segments[0][1].Destination.Airport.AirportCode}} <span>@{{flights2.Segments[0][1].Destination.Airport.CityName}}, @{{flights2.Segments[0][1].Destination.Airport.CountryName}}</span></h5>
                                        <div class="time_flts">(@{{ flights2.Segments[0][1].Destination.ArrTime |  date:'HH:mm' }})</div>
                                    </div>
                                    <div class="fllight_time_date" ng-if="!flights2.Segments[0][1] && !flights2.Segments[0][2]">
                                        <h5>@{{flights2.Segments[0][0].Destination.Airport.AirportCode}} <span>@{{flights2.Segments[0][0].Destination.Airport.CityName}}, @{{flights2.Segments[0][0].Destination.Airport.CountryName}}</span></h5>
                                        <div class="time_flts">(@{{  flights2.Segments[0][0].Destination.ArrTime  |  date:'HH:mm' }}) </div>
                                    </div>
                ...
                <!-- Flight Section  -->
                <div class="mobileOnlyView container mobileFlights" id="flightsList">
                                        ...
                                        <div class="flightlist" ng-if="flights1.Segments[0][0]">
                                            ...
                                            <div class="main_flts_time">
                                                ...
                                                <!-- <div class="time_hr">@{{flights1.Segments[0][0].Duration | time:'mm':'hhh mmm':false }}</div> -->
                                                <div class="flights1_duration" ng-if="flights1.Segments[0][2]">
                                                    <span>@{{ (flights1.Segments[0][0].Duration + flights1.Segments[0][1].Duration + flights1.Segments[0][2].Duration) | time:'mm':'hhh mmm':false}}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                                </div>
                                                <div class="flights1_duration" ng-if="flights1.Segments[0][1] && !flights1.Segments[0][2]">
                                    ...
                                    <div class="col-md-12">
                                        <div class="flex_width_air">
                                            ...
                                            <div class="main_flts_time">
                                                ...
                                                <!-- <div class="time_hr">@{{flights1.Segments[1][0].Duration | time:'mm':'hhh mmm':false }}</div> -->
                                                <div class="flights1_duration"  ng-if="flights1.Segments[1][2]">
                                                    <span>@{{ (flights1.Segments[1][2].Duration + flights1.Segments[1][1].Duration + flights1.Segments[1][0].Duration) | time:'mm':'hhh mmm':false}}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                                </div>
                                                <div class="flights1_duration"  ng-if="flights1.Segments[1][1] && !flights1.Segments[1][2]">
                        ...
                        <div class="flightlist" ng-if="flights2.Segments[0][0]">
                            <div class="flex_width_air">
                                ...
                                <div class="main_flts_time">
                                    ...
                                    <!-- <div class="time_hr">@{{flights2.Segments[0][0].Duration | time:'mm':'hhh mmm':false }}</div> -->
                                    <div class="flights2_duration" ng-if="flights2.Segments[0][2]">
                                        <span>@{{ (flights2.Segments[0][0].Duration + flights2.Segments[0][1].Duration + flights2.Segments[0][2].Duration) | time:'mm':'hhh mmm':false}}</span> <i class="fa fa-plane" aria-hidden="true"></i>
                                    </div>
                                    <div class="flights2_duration" ng-if="flights2.Segments[0][1] && !flights2.Segments[0][2]">
                        ...
                        <!-- Ends  --> 
                <div class="col-lg-9" style="padding-left:8px;padding-right:8px;" id="hotelcardsview">
                    <div class="row">
                        <div class="col-lg-7">
                        ...
                        <div class="tab-pane fade show active" id="hotel_listing" role="tabpanel" aria-labelledby="hotel_list_tab">
                            <div  class="listing_items_data" ng-if="hotels.length" >
                                <div class="row @{{ (hotelLayout == 'grid')?'HotelGridView':''}}" id="ListLayoutViews">
                                    <div  class="col-12 hotelgrids @{{ (hotelLayout == 'grid')?'col-lg-4':''}}" data-htype="@{{ (hotel.static_data.isHalal == 'yes')?'halal':''}}" data-rating="@{{ hotel.TBO_data.h_rating}}" data-price="@{{ hotel.TBO_data.Price.OfferedPriceRoundedOff + hotel.TBO_data.Price.TDS + (iniscomm / 100 * hotel.TBO_data.Price.OfferedPriceRoundedOff + hotel.TBO_data.Price.TDS)}}" data-code="@{{ hotel.TBO_data.HotelCode}}" ng-repeat="hotel in hotels track by $index" ng-init="h_key = $index" ng-click="viewHotel($event, hotel, referral)" data-tprating="@{{ hotel.static_data.tp_ratings}}" data-location="@{{ (hotel.static_data && hotel.static_data.hotel_address) ? hotel.static_data.hotel_address.CityName : searchData['Location']}}" data-distance="@{{ hotel.static_data.distance}}">
                                        <div class="row listing_item hotel-item" >
                                            ...
                                            <div class="col-5  @{{ (hotelLayout == 'grid')?'col-lg-12':'col-lg-3'}} hotelview imageoverlay" style="background:url(@{{ hotel.static_data.hotel_images || 'https://via.placeholder.com/250X150?text=Image%20Not%20Available' }});" ng-if="(hotel.static_data.hotel_images.indexOf('http') !== -1 || hotel.static_data.hotel_images.indexOf('www') !== -1)">
                                                <div class="pt-30" ng-if="hotel.TBO_data.FinalPrice > lottery_limit"></div>
                                                ...
                                                <div class="listing_description_data hotel_desc" >
                                                    <div class="row" >
                                                        ...
                                                        <div class="@{{ (hotelLayout == 'grid')?'col-lg-12':'col-lg-4'}} text-right hotel_price_box">
                                                            ...
                                                            <div class="share-post-icons" id="post_share_icon_@{{ hotel.static_data.hotel_name}} " style="margin-top:60px;margin-left:0px;">
                                                               <div class="row">
...
<script>
    ...
    $(document).ready(function () {
        $("#hotel_grid_tab").click(function () {
            ...
            $("#flightsList").removeClass("forceHideFlights");
        });
        ...
        $("#hotel_map_tab").click(function () {
            ...
            $("#flightsList").addClass("forceHideFlights");
        });
    });
