@extends(Auth::check() ? 'layouts.app-agent-header' : 'layouts.app-agent-header-noauth')
@section('content') 
<div class="app-content content {{ Auth::check() ? 'auth' : 'noauth' }}">
                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <input type="hidden" id="user_picture" value="{{$user_select['picture']}}">
                                <input type="hidden" id="user_name" value="{{$user_select['name']}}">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card profile-header mb-2">
                            <!-- profile cover photo -->
                            <img class="card-img-top profile-cover" src="/uploads/profiles/{{$agent_select->cover_pic}}" alt="User Profile Image" onerror="this.src=''; this.src='/images/agent/profile/user-uploads/timeline.jpg'" />
                            <!--/ profile cover photo -->
                            <div class="position-relative">
                                <!-- profile picture -->
                                <div class="profile-img-container d-flex align-items-center">
                                    <div class="profile-img">
                                        <img src="/uploads/profiles/{{ $user_select->picture }}" class="rounded img-fluid" alt="Card image" onerror="this.onerror=null;this.src='https://via.placeholder.com/200?text=No Image';" />
                                    </div>
                                    <!-- profile title -->
                                    <div class="profile-title ml-3">
                                        <h2 class="text-white">{{ $user_select->name }}</h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <p class="card-text">{{date('l, F d Y', strtotime($user_select['created_at'])) }}</p>
                                    </div>
                                    <div class="mt-2">
                                        <h5 class="mb-75">Lives:</h5>
                                        <p class="card-text">{{ $user_select['country'] }}</p>
                                    </div>
                                    <div class="mt-2">
                                        <h5 class="mb-75">Email:</h5>
                                        <p class="card-text">{{ $user_select['email'] }}</p>
                                    </div>
                                    <div class="mt-2">
                                        <h5 class="mb-50">Website:</h5>
                                        <p class="card-text mb-0">{{ $agent_select['website_url'] }}</p>
                                    </div>
                                </div>
                            </div>
                            <!--/ about -->
