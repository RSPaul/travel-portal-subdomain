...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/css/agent/pages/page-misc.css')}}">
    <!-- END: Page CSS-->
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="javascript:void(0);">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <p class="mb-2">Oops! 😖 The requested URL was not found on this server.</p><a class="btn btn-primary mb-2 btn-sm-block" href="{{env('APP_URL')}}">Back to home</a><img class="img-fluid" src="{{asset('/images/agent/pages/error.svg')}}" alt="Error page" />
                        </div>
                    </div>
                </div>
                <!-- / Error page-->
