...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <table width="100%" bgcolor="#eef2ef" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
   <tbody>
      <tr>
        <td>&nbsp;</td>
      </tr>
      ...
      <tr>
         <td>
           <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" >
               <tbody>
                  <tr>
                     <td width="100%" style="text-align:center;"><img style="width:120px;" src="https://via.placeholder.com/100X50?text=Our%20Logo"></td>
                  </tr>
               </tbody>
            </table>
         </td>
         ...
         <td>
           <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" >
               <tbody>
                  <tr>
                     <td width="100%">
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" bgcolor="#2d7235">
                           <tbody>
                              <!-- Spacing -->
                              <tr>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td width="100%" height="40" align="center">
                                                <div class="imgpop">
                                                   <a style="color:#fff; font-size:25px;" target="_blank" href="javascript:void(0);">
                                                   Tripheist
                                                   </a>
                                                </div>
                                             </td>
...
<table width="100%" bgcolor="#eef2ef" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="full-text">
   <tbody>
      <tr>
         <td>
                                 ...
                                 <td>
                                    <table width="500" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                       <tbody>
                                          ...
                                          <!-- content -->
                                          <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #606060; text-align:left; line-height: 18px;">
                                          ...
                                          <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #606060; text-align:left; line-height: 18px;">
                                              Please find the details below for failed payment:
                                            </td>
                                          </tr>
...
<!-- Start of preheader -->
<table width="100%" bgcolor="#eef2ef" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="preheader" >
   <tbody>
      <tr>
         <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                              ...
                              <tr>
                                 <td>
                                    <table width="600" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                       <tbody>
                                          <tr>
                                             <td width="100" align="left" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 11px;color: #666666; padding-left:30px;" st-content="viewonline">
                                                   &copy; 2020 Tripheist {{env('APP_URL')}}
                                             </td>
                                          </tr>
                                       </tbody>
                                    </table>
