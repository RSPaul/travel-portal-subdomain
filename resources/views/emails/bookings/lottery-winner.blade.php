                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="45%" valign="middle" align="right">
                                                    <p style="font-family:Helvetica,arial,sans-serif;font-size:15px;color:#9b9b9b;margin:0;margin-bottom:5px">Ticket Number: <span style="color:#000000;font-weight:bold;font-size:18px">{{ $ticketId }}</span></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="100%" align="center">
                                                                    <h1 style="font-family:arial,sans-serif;font-weight:normal;font-size:30px;color:#fffff0;text-align:left;line-height:1.0">You win the Lottery</h1>
                                                                    <h1 style="font-family:arial,sans-serif;font-weight:normal;font-size:30px;color:#fffff0;text-align:left;line-height:1.0">Won Amount:{{$lottery->feeCurrency}} {{$lottery->winAmount}}</h1>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <p style="color:#4a4a4a;font-family:Helvetica,arial,sans-serif;font-size:16px;line-height:25px;margin-top:15px;margin-bottom:0px;padding:0">
                                                        ⇒ We have credited winning amount into your  <b>Wallet</b> you may use it for further bookings.
                                                    </p>
                                                </td>
                                            </tr>
                                        </tbody>
