                                            ...
                                            <tr>
                                                <td>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="100%" align="center">
                                                                    <h1 style="font-family:arial,sans-serif;font-weight:normal;font-size:30px;color:#fffff0;text-align:left;line-height:1.0">You Successfully Enrolled for Lottery</h1>
                                                                    <h1 style="font-family:arial,sans-serif;font-weight:normal;font-size:30px;color:#fffff0;text-align:left;line-height:1.0">Lottery No. {{$lottery_no}}</h1>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <p style="color:#4a4a4a;font-family:Helvetica,arial,sans-serif;font-size:16px;line-height:25px;margin-top:15px;margin-bottom:0px;padding:0">
                                                        ...
                                                        Congrats! You are successfully enrolled for Lottery System while booking for <b>{{ $booking->request_data['hotelName'] }}.</b>

                                                    </p>

                                                    <p style="color:#4a4a4a;font-family:Helvetica,arial,sans-serif;font-size:16px;line-height:25px;margin-top:15px;margin-bottom:0px;padding:0">
                                                        ⇒ We have received your payment for <b>Lottery Enrollment</b>.
                                                    </p>
