<html>
   ...
   <body>
      <div style="font-family:Arial,Helvetica,sans-serif;margin:0;padding:0">
         <table class="m_7001975098023456892deviceWidth" width="100%"  border="0" align="center">
            <tbody>
               <tr>
                  <td>
                     <table class="m_7001975098023456892deviceWidth" style="margin:0 auto;font-family:Arial,Helvetica,sans-serif;width:850px" align="center"  border="0" width="850">
                        <tbody>
                           <tr>
                              <td style="border:1px solid #ccc;padding-top:35px;margin:0 auto;padding-bottom:30px;background-repeat:no-repeat">
                                 <table class="m_7001975098023456892deviceWidth" style="margin:0 auto" align="center"  border="0">
                                    <tbody>
                                       <tr>
                                       ...
                                       <tr>
                                          <td style="width:734px;background:#fff;border:1px solid #ccc;padding-top:34px;padding-bottom:15px;padding-left:30px;padding-right:30px">
                                             <table class="m_7001975098023456892deviceWidth" width="100%" border="0"  align="right">
                                                <tbody>
                                                   <tr>
                                                      <td>
                                                         <table border="0"  width="534">
                                                            <tbody>
                                                               <tr>
                                                                  <td style="text-align:center">                                                                                    <img alt="tripheist_logo" src="https://tripheist.com/images/logo.png" style="width: 170px" class="CToWUd">                                                                                </td>
                                                               </tr>
                                                               <tr>
                                                   ...
                                                   <tr>
                                                      <td style="width:394px">
                                                         <table  border="0" width="394" align="center" style="margin:0 auto">
                                                            <tbody>
                                                               <tr>
                                                               ...
                                                               <tr>
                                                                  <td style="padding-left:40px;padding-right:40px;width:434px">
                                                                     <table  border="0" width="455" align="center" style="margin:0 auto">
                                                                        <tbody>
                                                               ...
                                                               <tr>
                                                                  <td style="width:530px;padding:0px;border-bottom:1px solid #d6d6d6;border-left:1px solid #d6d6d6;border-right:1px solid #d6d6d6">
                                                                     <table width="530"  border="0">
                                                                        <tbody>
                                                                                 ...
                                                                                 <table  border="0" width="100%" style="border-collapse:collapse">
                                                                                    <tbody>
                                                                                       <tr>
                                                                                          ...
                                                                                          <td style="color:#6f6f6f;font-size:24px;line-height:27px;font-family:Arial,Helvetica,sans-serif;text-align:right;width:300px;padding-right:15px;padding-top:15px;padding-bottom:15px">
                                                                           ...
                                                                           <?php foreach ($segments as $key => $value) { ?>
                                                                           <tr>
                                                                              <td style="width:100px;padding:15px;border-top:1px solid #d6d6d6">
                                                                              ...
                                                                              <td style="width:100px;padding:15px;border-left:1px solid #d6d6d6;border-right:1px solid #d6d6d6;border-top:1px solid #d6d6d6">
                                                                                 <table  border="0" width="100">
                                                                                    <tbody>
                                                                                       <tr>
                                                               ...
                                                               <tr>
                                                                  <td style="width:500px;padding:15px;border-left:1px solid #d6d6d6;border-right:1px solid #d6d6d6">
                                                                     <table width="500"  border="0">
                                                                        <tbody>
                                                                           <tr>
                                                                              <td style="font-family:Arial,Helvetica,sans-serif;color:#a3a3a3;font-size:16px;width:200px;line-height:20px;text-align:left">                                    <span style="font-size:18px;line-height:20px;color:#71d6f7;font-family:Arial,Helvetica,sans-serif;font-weight:700">PASSENGERS</span> / {{ sizeof($booking->request_data['bookingData']['Passengers']) }} Adults                                </td>
                                                                           ...
                                                                           <tr>
                                                                              <td style="text-align:left;padding-top:15px;font-family:Arial,Helvetica,sans-serif;width:200px">
                                                                                                ...
                                                                                                <tbody>
                                                                                                   <tr>
                                                                                                      <td style="font-size:18px;line-height:20px;font-family:Arial,Helvetica,sans-serif;color:#a3a3a3;width:217px;padding:15px;border-right:1px solid #d6d6d6;border-top:1px solid #d6d6d6">
                                                                                                         Terminal
                                                                                                         <p style="font-size:20px;line-height:20px;font-family:Arial,Helvetica,sans-serif;color:#6f6f6f;margin:0;padding-top:15px;padding-bottom:15px">--</p>
                                                                                                      </td>
                                                   ...
                                                   <tr>
                                                      <td style="width:532px;border:1px solid #d6d6d6">
                                                   ...
                                                   <tr>
                                                      <td>
                                                         <table class="m_7001975098023456892deviceWidth"  border="0" style="border-collapse:collapse" width="534" align="center">
                                                            <tbody>
                                                               <tr>
                                                                  <td>
                                                                     <table class="m_7001975098023456892deviceWidth"  border="0" style="border-collapse:collapse">
                                                                        <tbody>
                                                                           <tr>
