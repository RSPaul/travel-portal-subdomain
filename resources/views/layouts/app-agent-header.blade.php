         ...
         <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
               ...
               <li class="nav-item d-none d-lg-block">
                  <a class="nav-link" href="/agent/wallet">
                     <i class="fa fa-money" ></i>
                     {{ wallet_blance()['currency'] }} {{ number_format(wallet_blance()['amount'],2) }}
                  </a>
               </li>
               ...
               <li class="nav-item dropdown dropdown-notification mr-25"><a class="nav-link" href="/" data-toggle="tooltip" data-placement="top" title="Open Website" target="_blankblank"><i class="ficon" data-feather="globe"></i></a></li>
               <li class="nav-item dropdown dropdown-notification mr-25">
                  <a class="nav-link" href="javascript:void(0);" data-toggle="dropdown"><i class="ficon" data-feather="bell"></i>@if(sizeof($notifications) > 0 )<span class="badge badge-pill badge-danger badge-up">{{ sizeof($notifications) }}</span>@endif</a>
                  <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                     <li class="dropdown-menu-header">
                        <div class="dropdown-header d-flex">
                           <h4 class="notification-title mb-0 mr-auto">Notifications</h4>
                           @if(sizeof($notifications) > 0 ) <div class="badge badge-pill badge-light-primary"></div>{{ sizeof($notifications) }} New @endif
                        </div>
                     </li>
                        ...
                        <a class="d-flex" href="javascript:void(0)">
                           <div class="media d-flex align-items-start">
                              <!-- <div class="media-left">
                                 <div class="avatar"><img src="{{asset('/images/agent/portrait/small/avatar-s-15.jpg')}}" alt="avatar" width="32" height="32"></div>
                              </div> -->
                              <div class="media-body">
                                 <p class="media-heading"><span class="font-weight-bolder"> {!!html_entity_decode($not['description'])!!} </span></p>
                     ...
                     <li class="dropdown-menu-footer"><a class="btn btn-primary btn-block" href="/agent/notifications">Read all notifications</a></li>
                  </ul>
               </li>
      ...
      <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
         ...
         <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
               <!-- <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/dashboard"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span><span class="badge badge-light-warning badge-pill ml-auto mr-1">2</span></a>
                  <ul class="menu-content">
                      <li><a class="d-flex align-items-center" href="/agent/dashboard"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Analytics">Analytics</span></a>
                      </li>
                      <li class="active"><a class="d-flex align-items-center" href="/agent/dashboard"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">My Earnings</span></a>
                      </li>
                  </ul>
                  </li> -->
               <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/dashboard"><i data-feather='home'></i><span class="menu-title text-truncate" data-i18n="Analytics">Dashboard</span></a>
               </li>
               <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/widget"><i data-feather='codepen'></i><span class="menu-title text-truncate" data-i18n="Email">HTML WIDGET</span></a>
               </li>
               <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/bannners"><i data-feather='credit-card'></i><span class="menu-title text-truncate" data-i18n="Chat">Banners</span></a>
               </li>
               <li class=" nav-item"><a class="d-flex align-items-center open-live-chat" href="javascript:void(0);"><i data-feather='message-square'></i><span class="menu-title text-truncate" data-i18n="Chat">Customer Support</span></a>
               </li>
               <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/kyc"><i data-feather='dollar-sign'></i><span class="menu-title text-truncate" data-i18n="Chat">Bank Details</span></a>
               </li>
               <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/withdraw"><i data-feather='git-pull-request'></i><span class="menu-title text-truncate" data-i18n="Chat">Withdraw Request</span></a>
               </li>
               <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/videos"><i data-feather='video'></i><span class="menu-title text-truncate" data-i18n="Chat">Videos</span></a>
               </li>
               <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/email"><i data-feather='mail'></i><span class="menu-title text-truncate" data-i18n="Chat">Emails</span></a>
               </li>
               <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/markup"><i data-feather='bookmark'></i><span class="menu-title text-truncate" data-i18n="Chat">Add Markup</span></a>
               </li>
               <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/earnings"><i data-feather='dollar-sign'></i><span class="menu-title text-truncate" data-i18n="Chat">My Earnings</span></a>
               </li>
               <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/wallet"><i class="fa fa-money"></i><span class="menu-title text-truncate" data-i18n="Chat">Wallet</span></a>
               </li>
               <li class=" nav-item"><a class="d-flex align-items-center" href="/agent/notifications"><i data-feather='check-square'></i><span class="menu-title text-truncate" data-i18n="Chat">Notifications</span></a>
               </li>
