      ...
      <div class="container">
         <div class="row headingtop">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
               <h2 class="textlog">Add New Activity</h2>
            </div>
         </div>
         <div class="row">
         ...
         <form action="/admin/activity/add" name="activities_form" method="POST" class="addcontainerpart" enctype="multipart/form-data">
            @csrf
            <div class="row">
               <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                  ...
                  <div class="form-group">
                     ...
                     <textarea id="editor4" name="short_description" class="form-control" value=""></textarea>
                  </div>
                  <div class="form-group">
                     <label>Description</label>
                     <textarea  id="editor5"name="description" class="form-control" value=""></textarea>
                  </div>
                  <!-- <div class="form-group">
