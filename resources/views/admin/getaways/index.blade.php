            ...
            <div class="row headingtop">
                ...
                <div class="col-lg-6">
                    <div class="text-right">
                        <a class="btn btn-success" href="{{ route('getaways.create') }}"> <span class="fa fa-plus-circle"></span> Add New</a>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-bordered dataTable addaddress" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->country}}</td>
                                    <td> 
                                        <form action="{{ route('getaways.destroy',$row->id) }}" method="POST">
                                            
                                            <a class="btn btn-primary btn-sm" href="{{ route('getaways.edit',$row->id) }}">Edit</a>
                                            @csrf
                                            @method('DELETE')
