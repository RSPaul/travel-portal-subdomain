...
<div id="page-content-wrapper">
    <section class="maindiv">
        <div class="container">
            <div class="row headingtop">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-right">
                    <a class="btn btn-primary" href="{{ route('getaways.index') }}"> Back</a>
                </div>
            </div>
        ...
        @endif
            ...
            <form action="{{ route('getaways.store')}}" name="location_form" method="POST" class="addcontainerpart" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-12">
