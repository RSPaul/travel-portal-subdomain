                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        <div class="form-group" style="padding:3px;margin:0px !important;">
                                                            ...
                                                            @endif
                                                            @if(Session::get('locale') == 'heb')
                                                            <input type="text" name="roomsGuests" id="roomsGuestsFH" style="padding-top:0px;" readonly class="form-control  text-center" required data-parsley-required-message="Please select the rooms & guests." placeholder="1 Room" value="חדר אחד 2 אורח">
                                                            @else
