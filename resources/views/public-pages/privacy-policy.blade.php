...
<section class="state_flight_info">
   <div class="container">
      <div class="row">
         <p class="text-center privacy-policy">Privacy Policy </p>
      </div>
      <div class="row">
         <p>&nbsp;Effective date: 2021-01-14 <a href="/docs/privacy-policy.docx" target="_blank" class="download-doc btn btn-primary">Download in Hebrew</a></p>
         <ul class="privacy-page">
         <li class="info-text-li">1. <b>Introduction</b><br>
            Welcome to <b>TRIP HEIST</b>.
            <b>TRIP HEIST</b> (“us”, “we”, or “our”) operates <b>tripheist.com</b> (hereinafter referred to as <b>“Service”</b>).
            Our Privacy Policy governs your visit to <b>tripheist.com</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.<br>
         ...
         <li class="info-text-li">2. <b>Definitions</b><br>
            <b>SERVICE</b> means the <b>tripheist.com</b> website operated by TRIP HEIST.
         ...
         <li class="info-text-li">3. <b>Information Collection and Use</b><br>
         ...
         <li class="info-text-li">
            5. Use of Data
            TRIP HEIST uses the collected data for various purposes:
            <ul class="privacy-page">
               <li class="info-text-li-inner">
         ...
         <li class="info-text-li">6. <b>Retention of Data</b><br>
         ...
         <li class="info-text-li">7. <b>Transfer of Data</b><br>
            ...
            <b>TRIP HEIST</b> will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.
         </li>
         <li class="info-text-li">8. <b>Disclosure of Data</b><br>
         ...
         0.2.7. if we believe disclosure is necessary or appropriate to protect the rights, property, or safety of the Company, our customers, or others.</li>
         <li class="info-text-li">9. <b>Security of Data</b><br>
            The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.
         <li class="info-text-li">10. <b>Your Data Protection Rights Under General Data Protection Regulation (GDPR)</b></li>
         If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR.
         We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.
         If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b><a href="mailto:support@tripheist.com">support@tripheist.com</a></b>.
         ...
         <li class="info-text-li">11. <b>Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</b></li>
         ...
         <ul class="privacy-page">
            ...
            <li class="info-text-li-inner">
               0.4. users are able to change their personal information by emailing us at <b><a href="mailto:support@tripheist.com">support@tripheist.com</a></b>.
            </li>
         </ul>
         ...
         <li class="info-text-li">12. <b>Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</b></li>
         If you are a California resident, you are entitled to learn what data we collect about you, ask to delete your data and not to sell (share) it. To exercise your data protection rights, you can make certain requests and ask us:
         <ul class="privacy-page">
            <li class="info-text-li-inner">
               0.1. <b>What personal information we have about you. If you make this request, we will return to you:</b>
            </li>
            <li class="info-text-li-inner">
         ...
         <ul class="privacy-page">
            <li class="info-text-li-inner">
               <b>0.2. To delete your personal information. If you make this request, we will delete the personal information we hold about you as of the date of your request from our records and direct any service providers to do the same. In some cases, deletion may be accomplished through de-identification of the information. If you choose to delete your personal information, you may not be able to use certain functions that require your personal information to operate.</b>
            </li>
            <li class="info-text-li-inner">
         ...
         To exercise your California data protection rights described above, please send your request(s) by email: <b><a href="mailto:support@tripheist.com">support@tripheist.com</a></b>.
         Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.</li><br>
         <li class="info-text-li">13. <b>Service Providers</b><br>
         ...
         <br>
         <li class="info-text-li">14. <b>Analytics</b><br>
            We may use third-party Service Providers to monitor and analyze the use of our Service.
         </li>
         <br>
         <li class="info-text-li">15. <b>CI/CD tools</b><br>
            We may use third-party Service Providers to automate the development process of our Service.
         </li>
         <br>
         <li class="info-text-li">16. <b>Behavioral Remarketing</b><br>
            We may use remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service.
         </li>
         <br>
         <li class="info-text-li">17. <b>Payments</b><br>
         ...
         <br>
         <li class="info-text-li">18. <b>Links to Other Sites</b><br>
         ...
         <br>
         <li class="info-text-li">19. <b>Children’s Privacy</b><br>
            Our Services are not intended for use by children under the age of 18 (“Child” or “Children”).
            We do not knowingly collect personally identifiable information from Children under 18. If you become aware that a Child has provided us with Personal Data, please contact us. If we become aware that we have collected Personal Data from Children without verification of parental consent, we take steps to remove that information from our servers.
         </li>
         <br>
         <li class="info-text-li">20. <b>Changes to This Privacy Policy</b><br>
         ...
         <li class="info-text-li">21. <b>Contact Us</b><br>
            If you have any questions about this Privacy Policy, please contact us by email: <b><a href="mailto:support@tripheist.com">support@tripheist.com</a></b>.
         </li>
      </div>
   </div>
</section>
