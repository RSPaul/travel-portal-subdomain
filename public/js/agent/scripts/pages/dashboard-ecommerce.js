...
$(window).on('load', function () {
  ...
  setTimeout(function () {
    toastr['success'](
      'You have successfully logged in to tripheist agent dashboard.',
  ...
  $.ajax({
    ...
    success: function(response) {
      ...
      earningsChartOptions = {
        ...
        series: response.earnings_by_category,
        legend: { show: false },
        comparedResult: [2, -3, 8, 5],
        labels: ['Hotels', 'Flights', 'Activites', 'Cabs'],
        stroke: { width: 0 },
      ...
      revenueReportChartOptions = {
        ...
        series: [
          {
            name: 'Sales',
            data: response.reveneue_report.sales
          },
          {
            name: 'Earnings',
            data: response.reveneue_report.earnings
          }
        ],
        dataLabels: {
          enabled: false
        ...
        xaxis: {
          categories: response.reveneue_report.months,
          labels: {
            style: {
    ...
    error: function(error) {
      toastr['error'](
        'Unable to load the data for charts.',
        {
          closeButton: true,
          tapToDismiss: false,
          rtl: isRtl
