(function ($) {
    ...
    try {
        ...
        $('#input-start').daterangepicker({
            ranges: true,
            autoApply: true,
            minDate: moment().startOf('hour').add(72, 'hour'),
        ...
        $('#input-start-2').daterangepicker({
            ...
            $('#input-start-2').val(start.format('DD/MM/YYYY'));
            $('#input-end-2').val(end.format('DD/MM/YYYY'));
        });
    ...
    try {
        ...
        btnAddRoom.on('click', function (e) {
            ...
            listRoom.append('<li class="list-room__item">' +
                ...
                '                                                        -' +
                '                                                    </span>' +
                '                                                    <input type="number" name="RoomGuests[adults][]" min="0" value="0" class="inputQty">' +
                '                                                    <span class="plus">' +
                '                                                        +' +
                '                                                    </span>' +
                '                                                </div>' +
                ...
                '                                                        -' +
                '                                                    </span>' +
                '                                                    <input type="number" name="RoomGuests[childrens][]" min="0" value="0" class="inputQty">' +
                '                                                    <span class="plus">' +
                '                                                        +' +
                '                                                    </span>' +
                '                                                </div>' +
